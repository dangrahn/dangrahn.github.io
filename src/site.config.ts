...
const config: SiteConfig = {
  ...
  socialLinks: {
    twitter: 'https://twitter.com/dangrahn',
    linkedin: 'https://www.linkedin.com/in/dangrahn/',
    github: 'https://github.com/dangrahn',
